<template>
  <div class="attendance-details">
    ...
    <div class="attendance-header">
      ...
      <!-- Header: Left -->
      <div class="attendance-header-left d-flex align-items-center">
        <span class="go-back mr-1">
          <feather-icon
            :icon="$store.state.appConfig.isRTL ? 'ChevronRightIcon' : 'ChevronLeftIcon'"
            size="20"
            class="align-bottom"
            @click="$emit('close-attendance-view')"
          />
        </span>
        <h4 class="attendance-subject mb-0">
          {{ attendanceViewData.subject }}
        </h4>
      </div>

      <!-- Header: Right -->
      <div class="attendance-header-right ml-2 pl-1">
        ...
        <feather-icon
          ...
          :class="{ 'text-warning fill-current': attendanceViewData.isStarred }"
          @click="$emit('toggle-attendance-starred')"
        />

        <!-- Move attendance to folder -->
        <b-dropdown
          variant="link"
          no-caret
          toggle-class="p-0"
        ...
        >
          ...
          <b-dropdown-item @click="$emit('move-attendance-to-folder', 'draft')">
            <feather-icon icon="Edit2Icon" />
            <span class="align-middle ml-50">Draft</span>
          </b-dropdown-item>

          <b-dropdown-item @click="$emit('move-attendance-to-folder', 'spam')">
          ...
          <b-dropdown-item
            ...
            @click="$emit('move-attendance-to-folder', 'trash')"
          >
        ...
        >
          ...
          <b-dropdown-item @click="$emit('update-attendance-label', 'personal')">
