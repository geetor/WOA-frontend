      ...
      <div class="app-fixed-search d-flex align-items-center">
        ...
        <div class="dropdown">
          ...
          >
            ...
            <b-dropdown-item :to="{ name: $route.name, query: { ...$route.query, sort: 'rank-asc' } }">
              按等级从低到高排序
            </b-dropdown-item>
            <b-dropdown-item :to="{ name: $route.name, query: { ...$route.query, sort: 'rank-desc' } }">
              按等级从高到低排序
            </b-dropdown-item>
            <b-dropdown-item :to="{ name: $route.name, query: { ...$route.query, sort: 'name-asc' } }">
              按姓氏从 A 到 Z 排序
            </b-dropdown-item>
            <b-dropdown-item :to="{ name: $route.name, query: { ...$route.query, sort: 'name-desc' } }">
              按姓氏从 Z 到 A 排序
            </b-dropdown-item>
          </b-dropdown>
        </div>
