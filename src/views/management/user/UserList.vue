...
export default {
  ...
  setup() {
    const INVOICE_APP_STORE_MODULE_NAME = 'manage-user'

    // Register module
    if (!store.hasModule(INVOICE_APP_STORE_MODULE_NAME)) store.registerModule(INVOICE_APP_STORE_MODULE_NAME, useStoreModule)
